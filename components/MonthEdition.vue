<template>
  <section class="month-edition">
    <div class="columns">
      <div class="column">
        <img id="book" src="~assets/images/book.svg" />
      </div>
      <div class="column">
        <h3 class="title is-3">In this month's edition</h3>
        <p>
        ...
        <!--<ButtonLink to="/magazine">Magazine</ButtonLink>-->
